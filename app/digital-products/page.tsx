...
export default function DigitalProductsPage() {
  ...
  }, [search, selectedCategory, minPrice, maxPrice, minRating, verifiedOnly, sort, page]);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 text-white py-8">
        <div className="container mx-auto px-4">
          <h1 className="text-2xl sm:text-3xl font-bold mb-1">Digital Products</h1>
          <p className="text-white/80 text-sm">{totalProducts} products available</p>
        </div>
      </div>
          ...
          {activeFilters.length > 0 && (
            <div className="flex flex-wrap gap-2 mt-2">
              {activeFilters.map((filter, i) => (
                <span key={i} className="inline-flex items-center gap-1 px-2 py-1 bg-indigo-50 text-indigo-700 text-xs rounded-full">
                  {filter}
