...
export default function AdminApprovalsPage() {
  const { } = useAuth(); // বা পুরোটা delete করুন
    ...
    <div>
      ...
      {loading ? (
        <div className="text-center py-20 bg-white rounded-xl">
          ...
          <p className="text-gray-500 mt-4">Loading pending products...</p>
        </div>
      ) : products.length > 0 ? (
            ...
            {products.map((product) => (
              <div key={product._id} className="lg:grid lg:grid-cols-12 gap-4 px-6 py-4 hover:bg-gray-50 transition-colors">
                ...
                <div className="lg:col-span-4 flex gap-3">
                  <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-violet-600 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              {/* Thumbnail */}
              <div className="h-56 bg-gradient-to-br from-indigo-500 to-violet-600 rounded-lg flex items-center justify-center">
          ...
          <div className="bg-white rounded-xl max-w-md w-full">
            <div className="p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                You are rejecting: <span className="font-medium">{selectedProduct.title}</span>
              </p>
